...
export type GameCompatPatch = { id: string; name: string; description: string; version: string; mode: 'live' | 'startup'; status: string; installed: boolean; enabled: boolean; update_available: boolean };
export type GameCompatSnapshot = { catalog_available: boolean; offer_required: boolean; recovery_available: boolean; recovery_disabled: boolean; offer_signature: string; error?: string; patches: GameCompatPatch[] };
export type State = {
  ...
  game_compat?: GameCompatSnapshot;
