    ...
    try {
      ...
      if (versionData.inheritsFrom) {
        ...
        try {
          ...
          // The launcher also needs the actual jar id for Forge's module-layer
          // ignore list. The child Forge id is not the name of the vanilla jar.
          versionData._mainJarVersionId = parentData.jar || parentId;
        } catch (parentErr) {
